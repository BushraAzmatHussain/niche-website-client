...
const ManageAllOrders = () => {
  ...
  useEffect(() => {
    axios
      .get("https://obscure-tor-50614.herokuapp.com/manageAllOrders")
  ...
  const handleDelete = (id) => {
    ...
    if (proceed) {
      axios
        .delete(`https://obscure-tor-50614.herokuapp.com/deletePurchasedCars/${id}`)
        .then((res) => {
  ...
  const handleEditStatus = (id) => {
    axios.put(`https://obscure-tor-50614.herokuapp.com/updateStatus/${id}`).then((res) => {
